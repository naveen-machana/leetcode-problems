...
* */
public class Problem1608_SpecialArrayWithXElementsGreaterThanOrEqualX {
    public static void main(String[] args) {
        Problem1608_SpecialArrayWithXElementsGreaterThanOrEqualX sol = new Problem1608_SpecialArrayWithXElementsGreaterThanOrEqualX();
        int[] a = {3,5};
        System.out.println(sol.specialArray(a));
    }
